...
# talk_kedro_polars documentation build
...
from talk_kedro_polars import __version__ as release

# -- Project information -----------------------------------------------------

project = "talk_kedro_polars"
author = "Kedro"
...
htmlhelp_basename = "talk_kedro_polarsdoc"
...
latex_documents = [
    (
        master_doc,
        "talk_kedro_polars.tex",
        "talk_kedro_polars Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "talk_kedro_polars",
        "Project talk_kedro_polars codebase.",
        "Data-Science",
    )
]
